          ...
          <form onSubmit={formik.handleSubmit} >
            <VStack spacing={4} >
              ...
              <FormControl >
                ...
                <Select id="type" name="type" color='#ffffff' fontWeight='bold' {...formik.getFieldProps("type")} focusBorderColor='#cebc81'>
              ...
              <Button type="submit" colorScheme='gray' bg='#990622' width="full">
                Submit
              </Button>
            </VStack>
          </form>
